...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="no-print bg-white/70 backdrop-blur-xl border-b border-white/20 sticky top-0 z-30 px-3 py-3 md:px-6 md:py-5 shadow-lg shadow-black/5">
        <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-6">
          <div className="flex items-center gap-3 md:gap-5">
            ...
            <div>
              <h1 className="month-title text-xl md:text-4xl font-black bg-gradient-to-r from-gray-900 via-gray-800 to-gray-700 bg-clip-text text-transparent leading-none">Indo-Assamese</h1>
          ...
          <div className="flex items-center justify-between md:justify-end gap-2 md:gap-4">
            ...
            >
              ...
              <span className="font-bold uppercase tracking-tight relative z-10 text-xs md:text-base">Print</span>
            </button>
          </div>
        </div>
      </header>
      ...
      <main className="flex-1 w-full max-w-[1700px] mx-auto p-3 md:p-6 lg:p-12">
        {loading ? (
          ...
          <div className="flex flex-col xl:flex-row gap-12">
            ...
            <div className="flex-1">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 calendar-grid">
      ...
      <footer className="no-print p-4 md:p-12 text-center mt-auto">
        <div className="inline-flex flex-wrap justify-center items-center gap-2 md:gap-4 px-4 py-3 md:px-8 md:py-4 bg-white/70 backdrop-blur-xl rounded-full border border-white/50 shadow-xl shadow-gray-200/50">
           <div className="relative">
             <div className="w-2 h-2 md:w-3 md:h-3 rounded-full bg-gradient-to-r from-green-400 to-emerald-500 animate-pulse"></div>
             <div className="absolute inset-0 w-2 h-2 md:w-3 md:h-3 rounded-full bg-green-400 animate-ping opacity-50"></div>
           </div>
           <p className="text-gray-600 text-[9px] md:text-[11px] font-black uppercase tracking-wider md:tracking-[0.2em]">
             AI Powered Regional Dates
           </p>
        </div>
      </footer>
    </div>
